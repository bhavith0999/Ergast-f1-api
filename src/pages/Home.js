    ...
    return (
        <div className='grid place-content-center bg-red-800 text-white h-screen w-screen overflow-auto '>
            ...
            <div className='w-96 space-y-3'>
                <h1 className='text-left text-6xl font-bold '>Formula 1 races</h1>
                <p className='w-fit text-justify'>Replay a race <strong className=' font-f1'>lap by lap!</strong>. Just select the year and the race and see the animation <i>(for now only works for races of 1996 or above)</i>.</p>
            </div>
